...
<header role="banner" class="navbar navbar-fixed-top<?php echo $html->navbarclass ?>">
    <nav role="navigation" class="navbar-inner">
        <div class="container-fluid">
            ...
            <img src="http://seminario.apoyoalajuventud.org/img/bannerHeader.png"/>
            </div>
            ...
            <!-- -->
            <div style="float:right;"><img src="http://seminario.apoyoalajuventud.org/img/bannerHeaderRgh.png"/></div>
        </div>
    </nav>
</header>
...
<script src="http://code.jquery.com/jquery.js"></script>
<script src="http://seminario.apoyoalajuventud.org/js/bootstrap.min.js"></script>
